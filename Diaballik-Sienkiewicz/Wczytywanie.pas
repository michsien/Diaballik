...
procedure TEkranWczytywania.GuzikWczytajGreClick(Sender : TObject);
  ...
  begin
    ...
    ShowMessage('To nie jest plik z gr¹, wiêc w³¹czyliœmy Ci grê klasyczn¹.');
...
begin
  ...
  if IOresult<>0 then
    begin
      ShowMessage('Œcie¿ka jest niepoprawna');
      Exit;
    end;
  ...
  WczytajNapis(Plik,Zle,Napis,'Cz³owiek1','Komputer1');
  WczytajNapis(Plik,Zle,Napis2,'Cz³owiek2','Komputer2');
