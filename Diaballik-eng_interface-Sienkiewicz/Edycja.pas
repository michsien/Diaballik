...
const
  WYBIERZ_GRACZA='Choose the current player';
...
begin
  ...
  ListaWybierzGracza.Text:=WYBIERZ_GRACZA;
...
begin
  ...
  if ListaWybierzGracza.ItemIndex=-1 then
    begin
      ShowMessage('The chosen current player is invalid!!');
      Exit;
    end
  else if MessageDlg('The current game will be lost!', mtConfirmation,
